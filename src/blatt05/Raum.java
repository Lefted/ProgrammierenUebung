...
public class Raum {
	...
	/**
	 * Alternativer Konstruktor: Kürzel aus Kürzel für Gebäudenamen und Raumnummer
	 * bauen
	 * 
	...
	public void setAnzahlPlaetze(int plaetze) {
		...
		} else if (plaetze < 1_000) {
			System.err.println("Der Raum kann nicht mehr als 999 Plätze haben");
		} else {
	...
	/**
	 * Kürzel zurückgeben. Konvention: nur in Großbuchstaben, egal, was in der
	 * Instanzvariable steht
	 */
	...
	public static void main(String[] a) {
		// Ein Objekt der Klasse Raum mit Gebäude-Kürzel, Nummer und Sitzzahl
		// instanziieren
